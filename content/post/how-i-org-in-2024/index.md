...
As of Friday, January  5, 2024
 I had `57MB` of `.org` files in `~/org`. That's `4939` files and `1194682` lines of text, the largest single file was `1.3M` and the longest lined file was `26370` lines.

`4769` of these files were inside Org-roam[^fn:2], the majority of them (`3602`) were "dailies"[^fn:3].
